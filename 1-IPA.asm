...
speech_a_short:                 ; /a/ (Hatt)
        .byte R11,$05, R12,$00
        .byte R4,$39, R5,$00
        .byte NOISE,$0d, ENV,LOOP_SAW, WAIT4, RET
speech_a_long:                  ; /ɑː/ (Hata)
        .byte R11,$05, R12,$00
        .byte R4,$34, R5,$00
        .byte NOISE,$0c, WAIT4, ENV,LOOP_SAW, RET

; --- O Group ---
speech_o_short:                ; /ʊ/ (Bott)
        .byte R11,$08, R12,$00
        .byte R4,$4f, R5,$00
        .byte NOISE,$0e, ENV,LOOP_TRI, WAIT4, RET
speech_o_long:                  ; /uː/ (Bo)
        .byte R11,$07, R12,$00
        .byte R4,$4a, R5,$00
        .byte NOISE,$0d, ENV,LOOP_TRI, WAIT4, RET

; --- U Group ---
speech_u_short:                 ; /ɵ/ (Hund)
        .byte R11,$09, R12,$00
        .byte R4,$3d, R5,$00
        .byte NOISE,$0e, WAIT4, ENV,LOOP_TRI, RET
...
speech_ue_long:                 ; /yː/ (German ü / Syla)
        .byte R11,$11, R12,$00
        .byte R4,$29, R5,$00
        .byte NOISE,$0b, WAIT4, ENV,LOOP_SAW, RET

; --- E Group ---
speech_e_short:                 ; /ɛ/ (Hetta)
        .byte R11,$08, R12,$00
        .byte R4,$25, R5,$00
        .byte NOISE,$0d, WAIT4, ENV,LOOP_SAW, RET 
speech_e_long:                  ; /eː/ (He)
        .byte R11,$0b, R12,$00
        .byte R4,$1e, R5,$00
        .byte NOISE,$0b, WAIT4, ENV,LOOP_SAW, RET
...
speech_i_short:                 ; /ɪ/ (Sill)
        .byte R11,$0e, R12,$00
        .byte R4,$1e, R5,$00
        .byte NOISE,$0a, WAIT4, ENV,LOOP_SAW, RET
speech_i_long:                  ; /iː/ (Sil)
        .byte R11,$10, R12,$00
        .byte R4,$1b, R5,$00
        .byte NOISE,$09, WAIT4, ENV,LOOP_SAW, RET
...
speech_oe_short:                ; /œ/ (Nött)
        .byte R11,$09, R12,$00
        .byte R4,$30, R5,$00
        .byte NOISE,$0e, WAIT4, ENV,LOOP_SAW, RET
